...
def chart_disp(chart_op, plt, dnode, rnodes, Sdate, Edate):
    ...
    line, = ax.plot(xdata[:drange], y1data[:drange],
        #color=colors[0], ls = linestyles[0],
        linewidth = 1, label = llabel(dnode, menusy1[1], 'Y-axis 1', variant))
    ...
    if dnode.inputs['Y-axis 2'].links:
        ...
        line, = ax.plot(xdata[:drange], y2data[:drange],
            #color=colors[1], ls = linestyles[1],
            linewidth = 1, label = llabel(dnode, menusy2[1], 'Y-axis 2', variant))
    ...
    if dnode.inputs['Y-axis 3'].links:
        ...
        line, = ax.plot(xdata[:drange], y3data[:drange],
            #color=colors[2], ls = linestyles[2],
            linewidth = 1, label=llabel(dnode, menusy3[1], 'Y-axis 3', variant))
